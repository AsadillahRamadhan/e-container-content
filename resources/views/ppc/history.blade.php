      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                @error('invNum')
                <small class="text-info">Masukkan No. Invoice</small>
                @enderror
            </div>
        </div>
            ...
            <table class="table align-items-center mb-0">
              ...
              <tbody class="text-center">
                ...
                <tr class="text-truncate" style="">
                    ...
                    @if($h->approved_by_ppc == 1)
                    <td class="d-flex items-center align-middle"><button class="btn bg-gradient-info me-2" data-bs-toggle="modal" data-bs-target="#check{{ $h->id }}"><i class="fa-solid fa-edit"></i></button></td>
                    @else
