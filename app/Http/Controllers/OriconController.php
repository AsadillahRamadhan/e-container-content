...
use App\Imports\OriconImport;
use Dompdf\Dompdf;
use Illuminate\Http\Request;
use Maatwebsite\Excel\Facades\Excel;

class OriconController extends Controller
{
    public function index(){
        return view('oricon.index',[
            'title' => 'ORICON'
        ]);
    }
    ...
    public function convert(Request $request){
        ...
        $data = Excel::toArray(new OriconImport, $request->file('rawFile'), null, \Maatwebsite\Excel\Excel::XLS);
